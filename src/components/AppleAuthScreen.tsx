      ...
      >
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full py-3.5 px-4 rounded-2xl border border-black/10 dark:border-white/15 bg-white/80 dark:bg-white/10 hover:bg-white dark:hover:bg-white/20 text-neutral-900 dark:text-white font-bold text-xs flex items-center justify-center gap-3 transition-all shadow-sm active:scale-98"
          >
        ...
        <div className="mt-8 pt-4 border-t border-black/5 dark:border-white/10 flex items-center justify-center gap-1.5 text-[11px] text-neutral-400 font-medium">
