      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md apple-glass rounded-3xl p-6 shadow-2xl z-10 overflow-hidden"
          >
              ...
              <div className="flex items-center gap-2">
                ...
                {[10000, 15000, 20000, 30000].map((preset) => (
                  <button
                    ...
                    className="px-2.5 py-1 text-xs font-bold rounded-xl bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 transition-all"
                  >
