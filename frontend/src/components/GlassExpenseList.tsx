    ...
    <div className="apple-card w-full">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-xs rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 text-neutral-900 dark:text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
              />
            </div>

            {/* Sort & Export Buttons */}
            <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 text-xs font-semibold text-neutral-700 dark:text-neutral-300">
              ...
              {onExportCSV && (
                <button
                  onClick={onExportCSV}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-2xl bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 transition-all text-neutral-800 dark:text-neutral-200"
                  title="Export to CSV"
                >
      ...
      {filteredExpenses.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <div className="w-14 h-14 rounded-3xl bg-black/5 dark:bg-white/10 flex items-center justify-center mb-3">
            <ReceiptText className="w-7 h-7 text-neutral-400" />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {onLoadSampleData && (
              <button onClick={onLoadSampleData} className="btn-secondary">
