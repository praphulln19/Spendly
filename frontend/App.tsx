...
function Brand() { const { palette } = useTheme(); return <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}><Image source={require('./assets/spendly-logo.png')} style={{ width: 28, height: 28 }} resizeMode="contain" accessibilityLabel="Spendly logo" /><Text style={{ color: palette.ink, fontSize: 19, fontWeight: '800' }}>Spendly</Text></View> }
