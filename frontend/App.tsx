...
function TabNavigator() {
  return <Tabs.Navigator screenOptions={({ route }) => ({ headerStyle: { backgroundColor: colors.white }, headerShadowVisible: false, tabBarActiveTintColor: colors.blue, tabBarInactiveTintColor: '#94a3b8', tabBarStyle: { borderTopColor: colors.border }, tabBarIcon: ({ color, size }) => <Ionicons name={route.name === 'Dashboard' ? 'grid-outline' : 'receipt-outline'} color={color} size={size} /> })}><Tabs.Screen name="Dashboard" component={DashboardScreen} options={{ title: 'Spendly' }} /><Tabs.Screen name="Expenses" component={ExpensesScreen} options={{ title: 'Expenses' }} /></Tabs.Navigator>
}
